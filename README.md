...
<head>
    ...
    <style>
        ...
        .add-to-cart:hover {
            background-color: #5a3b2a !important;
        }
    </style>
</head>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="menu-items">
            ...
            <div class="menu-item bg-white rounded-lg overflow-hidden" data-category="coffee">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-xl font-bold text-amber-800">$4.50</span>
                        <button class="add-to-cart bg-amber-800 text-white px-4 py-2 rounded-full hover:bg-amber-700">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-lg overflow-hidden" data-category="coffee">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-xl font-bold text-amber-800">$5.00</span>
                        <button class="add-to-cart bg-amber-800 text-white px-4 py-2 rounded-full hover:bg-amber-700">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-lg overflow-hidden" data-category="food">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-xl font-bold text-amber-800">$8.50</span>
                        <button class="add-to-cart bg-amber-800 text-white px-4 py-2 rounded-full hover:bg-amber-700">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-lg overflow-hidden" data-category="food">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-xl font-bold text-amber-800">$9.50</span>
                        <button class="add-to-cart bg-amber-800 text-white px-4 py-2 rounded-full hover:bg-amber-700">Add to Cart</button>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-lg overflow-hidden" data-category="dessert">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-xl font-bold text-amber-800">$5.50</span>
                        <button class="add-to-cart bg-amber-800 text-white px-4 py-2 rounded-full hover:bg-amber-700">Add to Cart</button>
                    </div>
                </div>
            </div>
